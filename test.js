...
/*            s.name = "TurnstileError",
    ...
    function cr(e, r) {
        var t, i = rt(r.params, oe), f = "h/".concat("g", "/"), s = document.getElementById(e);
        if (!s) {
    ...
    var st = function() {
        ...
        function b(d) {
            ...
            if (n) {
                ...
                var p;
                a.src = nt(o, n.params.sitekey, n.params, (p = n.rcV) !== null && p !== void 0 ? p : W, oe, "g", tt(n)),
                it(c),
        ...
        function S(d, o) {
            ...
            if (h) {
                ...
                if (!(!D || !B)) {
                    ...
                    N.setAttribute("src", nt(D, C, l, W, oe, "g", tt(ft)));
